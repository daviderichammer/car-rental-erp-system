...
# Car Rental ERP - Fixed MySQL Deployment Script
# This version fixes the git repository error and provides better error handling
...
show_usage() {
    echo "Car Rental ERP - Fixed MySQL Deployment Script"
    echo
    ...
    echo "  sudo ./deploy_mysql_fixed.sh"
    echo
    echo "  # Custom installation path"
    echo "  sudo INSTALL_PATH=/home/myuser/carrental ./deploy_mysql_fixed.sh"
    echo
    echo "  # Custom domain"
    echo "  sudo DOMAIN_NAME=mycarrental.com ./deploy_mysql_fixed.sh"
    echo
}
